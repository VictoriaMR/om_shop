...
<body class="index">
    ...
    <div class="container">
        <div class="logo">
            <a href="admin/index/index"><?php echo $_SESSION['admin_user']['name'] ?? '';?></a></div>
        <div class="left_open">
        ...
        <ul class="layui-nav right" lay-filter="">
            <li class="layui-nav-item">
                <a href="javascript:;"><?php echo $_SESSION['admin_user']['name'] ?? '';?></a>
                <dl class="layui-nav-child">
                    <!-- 二级菜单 -->
                    <dd>
            ...
            <ul id="nav">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a onclick="xadmin.add_tab('会员列表(静态表格)',ADMIN_URL + 'member/memberList')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>会员列表</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('商品列表', ADMIN_URL + 'product/productList')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>商品列表</cite>
                            </a>
                        </li>
                        <li>
                            <a onclick="xadmin.add_tab('新增商品', ADMIN_URL + 'product/productPage')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>新增商品</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('订单列表', ADMIN_URL + 'order/orderList')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>订单列表</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('商品分类', ADMIN_URL + 'product/category')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>商品分类</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('管理员列表', ADMIN_URL + 'member/memberList')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>管理员列表</cite></a>
                        </li>
                    </ul>
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe src="/admin/index/overview" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                </div>
            </div>
            <div id="tab_show"></div>
        </div>
